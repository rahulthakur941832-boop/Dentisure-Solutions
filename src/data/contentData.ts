...
export const BRAND = {
  ...
  legalEntityName: 'DentiSure Solutions LLC',
  tagline: 'Your Certainty in Dental Revenue',
  contactEmail: 'usmilesbilling@gmail.com',
  inquiriesEmail: 'info@dentisuresolutions.com',
  phone: '(888) 542-SURE',
  phoneDirect: '(888) 542-7873',
  address: 'Austin, Texas, United States [Official US Business Address — Configurable in Admin Settings]',
  usBusinessAddress: 'Austin, Texas, United States [Registered Business Address — Update in Admin Settings]',
  mailingAddress: 'Austin, Texas, United States [Mailing Address — Update in Admin Settings]',
  billingAddress: 'Electronic Invoicing & ACH / Direct Wire Transfer Available',
  businessSetupType: 'US Registered Business Entity — Nationwide Remote Dental RCM',
  einTaxIdNotice: '[EIN / Tax ID on File — Disclosed upon Mutual BAA / W-9 Execution]',
  hours: 'Mon – Fri: 7:30 AM – 6:00 PM CST (Coverage for all US Time Zones)',
};
...
export const HERO_OPTIONS: Record<HeroPerspective, {
  ...
  elite: {
    ...
    headline: 'Insurance Billing, Perfected.',
    subheadline: 'No guesswork. No lost revenue. Just a streamlined, HIPAA-ready system that captures every dollar your dental practice earns.',
    primaryCta: 'Request Confidential Revenue Audit',
    secondaryCta: 'Explore Our Process',
    highlightPills: ['HIPAA-Ready Remote VPN', '98%+ Clean Claim Acceptance', 'Dedicated Dental Billing Specialists'],
  },
  'stress-free': {
    badge: 'The Stress-Free Practice Partner',
    headline: 'Stop Chasing Payments. Start Focusing on Care.',
    subheadline: 'We handle the relentless insurance maze for you, ensuring your practice gets paid accurately and on time while your front desk focuses on patients.',
    primaryCta: 'Schedule a Free Practice Consultation',
    secondaryCta: 'Learn How We Work',
    highlightPills: ['Reclaim 20+ Front Desk Hours/Week', 'Zero Insurance Hold Times for Staff', 'Dedicated Account Manager'],
  },
  growth: {
    badge: 'Strategic Revenue Multiplication',
    headline: 'Turn Your Billing Department into a Profit Center.',
    subheadline: 'A dedicated revenue cycle team that recovers hidden insurance leakage, slashes aging balances, and accelerates healthy cash flow.',
    primaryCta: 'Calculate Your Practice ROI',
    secondaryCta: 'See Financial Benchmarks',
    highlightPills: ['Average $48K+ Recovered in 90 Days', '50% Reduction in 90+ Day AR', 'Contingency-Aligned Pricing'],
  },
};
...
export const METRICS_DATA: Record<MetricFocus, {
  ...
  cashflow: {
    ...
    subtitle: 'Proven benchmarks compared to standard US dental practice averages',
    stats: [
      { value: '18–24 Days', label: 'Average Days in AR', detail: 'Versus 35–45 days industry standard' },
      { value: '>95%', label: 'First-Pass Acceptance', detail: 'Clean claims paid without delays' },
      { value: '<5%', label: 'Claim Denial Rate', detail: 'Over 60% lower than 13% national avg' },
      { value: '>98%', label: 'Net Collection Ratio', detail: 'Every legitimate dollar captured' },
    ],
  },
  efficiency: {
    title: 'Operational Hours & Friction Saved',
    subtitle: 'Freeing your front-desk team from soul-crushing phone hold times',
    stats: [
      { value: '20+ Hrs', label: 'Saved Per Week', detail: 'Reclaimed for patient care & treatment acceptance' },
      { value: '72 Hours', label: 'Prior Verification', detail: 'Full breakdown in PMS before patient arrives' },
      { value: '24 Hours', label: 'Turnaround on Submissions', detail: 'Claims sent with clean radiographs & narratives' },
      { value: '0 Backlog', label: 'Aging Claim Discipline', detail: 'Unresolved balances reviewed every 14 days' },
    ],
  },
  outcomes: {
    title: 'Documented Practice Impact',
    subtitle: 'Measured across general practices, pediatric groups, and multi-location DSOs',
    stats: [
      { value: '50%+', label: 'Reduction in 90+ Day AR', detail: 'Within the first 90 days of onboarding' },
      { value: '$45K–$85K', label: 'Cash Flow Unlocked', detail: 'From dormant and unresolved aging claims' },
      { value: '88%', label: 'Appeals Overturned', detail: 'Recovering money written off by other practices' },
      { value: '100%', label: 'PMS Compatibility', detail: 'Direct login to Dentrix, Eaglesoft, Open Dental' },
    ],
  },
};
...
export const TESTIMONIALS: TestimonialItem[] = [
  {
    ...
    practiceName: 'Apex Family Dental Care',
    location: 'Denver, CO',
    pms: 'Open Dental',
    quote: 'Before DentiSure, our front desk was drowning in insurance phone calls. Our 90-day AR was sitting at $78,000. Within 60 days of partnering with DentiSure, that balance was down to $16,000, and our collections jumped by $14,000 in the first month alone.',
    metricsResult: '79% Reduction in 90+ Day AR in 60 Days',
  ...
  },
  {
    ...
    practiceName: 'Sonoma Smiles Dentistry',
    location: 'Santa Rosa, CA',
    pms: 'Dentrix G7',
    quote: 'DentiSure feels like they are sitting in the room next door, but without the payroll overhead. They log into Dentrix every single afternoon, post every EOB, and resolve denials before I even notice them. It restored total peace of mind to our office.',
  ...
  },
  {
    ...
    practiceName: 'North Texas Periodontics',
    location: 'Plano, TX',
    pms: 'Eaglesoft',
    quote: 'Surgical and periodontal claims are notorious for denials. DentiSure’s team knows exactly what narrative and periodontal charting Delta, MetLife, and Cigna require. Our first-pass acceptance rate is now 98.4%, and our cash flow has never been more predictable.',
    metricsResult: '98.4% Clean Claim First-Pass Acceptance',
...
export const FAQ_BANK: FAQItem[] = [
  {
    ...
    answer: 'DentiSure Solutions is a premier dental insurance billing and revenue cycle management service supporting dental practices nationwide across all 50 US states. We handle pre-visit eligibility verification, daily clean claim submissions, payment posting, aging AR recovery, and aggressive denial appeals under the tagline: Your Certainty in Dental Revenue.',
  },
  {
    id: 'faq-2',
    category: 'Security & Tech',
    question: 'How do you access our dental software securely?',
    answer: 'We connect directly to your existing practice management software (Dentrix, Eaglesoft, Open Dental, Curve, etc.) using an encrypted, HIPAA-ready VPN or secure remote desktop connection. We execute a mutual HIPAA Business Associate Agreement (BAA) before any work begins, and all patient data remains strictly inside your own system.',
  },
  {
    id: 'faq-3',
    category: 'Billing & Claims',
    question: 'How does your team specialize in US dental insurance billing?',
    answer: 'Our dedicated team consists of seasoned dental billing specialists with comprehensive expertise in ADA CDT codes, dental clearinghouses, state payer rules, and denial appeal strategies. We operate with zero software migration, working directly within your authorized PMS.',
  },
  {
    id: 'faq-4',
    category: 'Onboarding',
    question: 'How quickly can our dental practice get started?',
    answer: 'Our rapid onboarding takes just 5 to 7 business days. After a 30-minute discovery call, we configure secure remote access, align on your practice fee schedules, sign our BAA, and begin active billing. You do not need to install new software or change clearinghouses.',
  },
  {
    id: 'faq-5',
    category: 'Pricing',
    question: 'What is your pricing structure?',
    answer: 'We offer transparent, performance-aligned pricing. Our Full Revenue Cycle service is typically between 2.9% and 3.8% of actual insurance collections, meaning we only get paid when you get paid. For eligibility verification only, pricing starts at $3.50 per verified patient. We do not lock you into rigid multi-year contracts.',
  },
  {
    id: 'faq-6',
    category: 'Billing & Claims',
